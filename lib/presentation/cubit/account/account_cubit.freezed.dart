...
mixin _$AccountState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(int? amount) success,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(int? amount)? success,
...
class _$SuccessImpl implements _Success {
  const _$SuccessImpl(this.amount);
  ...
  @override
  String toString() {
    return 'AccountState.success(amount: $amount)';
  }
...
abstract class _Success implements AccountState {
  const factory _Success(final int? amount) = _$SuccessImpl;
