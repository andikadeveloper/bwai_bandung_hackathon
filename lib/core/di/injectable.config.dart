...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i16.CreateRecommendation>(() => _i16.CreateRecommendation(
          gh<_i3.GeminiRepository>(),
          gh<_i8.TransactionRepository>(),
        ));
    gh.factory<_i17.ProfileCubit>(
        () => _i17.ProfileCubit(gh<_i15.GetUserUseCase>()));
    gh.factory<_i18.GetDefaultCategory>(
        () => _i18.GetDefaultCategory(gh<_i6.CategoryRepository>()));
    gh.factory<_i19.GetCategories>(
        () => _i19.GetCategories(gh<_i6.CategoryRepository>()));
    gh.factory<_i20.UpsertTransaction>(
        () => _i20.UpsertTransaction(gh<_i8.TransactionRepository>()));
    gh.factory<_i21.LoginCubit>(
        () => _i21.LoginCubit(gh<_i14.SignInUseCase>()));
    gh.factory<_i22.CategoryCubit>(
        () => _i22.CategoryCubit(gh<_i19.GetCategories>()));
    gh.factory<_i23.FormTransactionCubit>(() => _i23.FormTransactionCubit(
          gh<_i20.UpsertTransaction>(),
          gh<_i18.GetDefaultCategory>(),
    ...
    gh.factory<_i25.RecommendationCubit>(
        () => _i25.RecommendationCubit(gh<_i16.CreateRecommendation>()));
    return this;
  }
}
